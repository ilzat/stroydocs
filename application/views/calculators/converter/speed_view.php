		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<table class="table" id="converter_table_2">
					...
					<tbody>
						<tr>
							<td><input id="text_1" type="text" class="form-control" placeholder="0" onkeyup="speed(1);"/></td>
							<td style="width: 70px!important;">
								<select id="select_1_1" class="form-control" onchange="speed(1);">
							...
							<td style="width: 100px!important;">
								<select id="select_1_2" class="form-control opt_1" onchange="speed(1);">
						...
						<tr>
							<td><input id="text_2" type="text" class="form-control" placeholder="0" onkeyup="speed(2);"/></td>
							<td>
								<select id="select_2_1" class="form-control" onchange="speed(1);">
									<option value="1">км</option>
									<option value="0.001">м</option>
									<option value="0.00001">см</option>
									<option value="0.000001">мм</option>
							...
							<td>
								<select id="select_2_2" class="form-control opt_2" onchange="speed(1);">
									<option value="3600">час</option>
									<option value="60">мин</option>
									<option value="1">сек</option>
								</select>
