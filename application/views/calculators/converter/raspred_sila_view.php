		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<table class="table" id="converter_table_2">
					...
					<tbody>
						<tr>
							<td><input id="text_1" type="text" class="form-control" placeholder="0" onkeyup="raspred_sila(1);"/></td>
							<td style="width: 70px!important;">
								<select id="select_1_1" class="form-control" onchange="raspred_sila(1);">
							...
							<td style="width: 90px!important;">
								<select id="select_1_2" class="form-control" onchange="raspred_sila(1);">
						...
						<tr>
							<td><input id="text_2" type="text" class="form-control" placeholder="0" onkeyup="raspred_sila(2);"/></td>
							<td>
								<select id="select_2_1" class="form-control" onchange="raspred_sila(1);">
									<option value="1">N</option>
									<option value="1000">kN</option>
									<option value="1000000">mN</option>
									<option value="9.80664999999931">кг</option>
							...
							<td>
								<select id="select_2_2" class="form-control" onchange="raspred_sila(1);">
									<option value="1">м</option>
									<option value="0.01">см</option>
									<option value="0.001">мм</option>
									<option value="0.0254">дюйм</option>
