		...
		<div class="box box-primary">
			...
			<div class="box-body">
				<table class="table lin_size" id="converter_table">
					...
					<tbody>
						<tr>
							<td style="width: 55%;">Час</td>
							<td><input id="text_0" type="text" class="form-control" placeholder="0" onkeyup="times_convert(0);"/></td>
						</tr>
						<tr>
							<td>Мин</td>
							<td><input id="text_1" type="text" class="form-control" placeholder="0" onkeyup="times_convert(1);" /></td>
						</tr>
						<tr>
							<td>Сек</td>
							<td><input id="text_2" type="text" class="form-control" placeholder="0" onkeyup="times_convert(2);" /></td>
						</tr>
					</tbody>
				</table>
			</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <p>Онлайн конвертирование величин Час - Мин - Сек. Калькулятор работает автоматически, достаточно лишь заполнить любое поле.</p>
