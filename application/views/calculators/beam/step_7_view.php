...
<div class="row">
  <div class="col-md-8">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form action="<?=base_url();?>beam/step_8" method="POST" id="beam_form" class="form-horizontal">
          <p>Расчетная схема балки:</p><br />
          <?=$canvas;?>
          <br />
          <input type="text" name="hidden" hidden="" />
          <p style="margin-bottom: 6px;">Проверьте правильность заданной расчетной схемы</p>
          <p style="margin-bottom: 6px; text-align: center;"><button type="submit" class="btn btn-info">Показать решение</button> </p>
        </form>
      </div>
    </div>
  </div><!-- /.col -->
